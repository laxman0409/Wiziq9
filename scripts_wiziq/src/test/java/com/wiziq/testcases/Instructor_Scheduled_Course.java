...
public class Instructor_Scheduled_Course extends Testbase {
	@Test(priority=1)
	public void instructor() throws InterruptedException, AWTException, IOException
	{
		...
		// WebDriverWait wait = new WebDriverWait(driver, 100);
	   		//WebElement Category_Body = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(OR.getProperty("add_course1"))));
	   		//Category_Body.click();
	   		//Thread.sleep(5000);
	   		//driver.findElement(By.xpath("//a[normalize-space()='schedule']")).click();
	   		//Thread.sleep(5000);
	    ...
	    driver.findElement(By.id("txtTitle")).sendKeys("Scheduled_course_via_automation_At_Instructor End");
        ...
        WebElement elm1 = driver.findElement(By.id("frameExisting"));
         ...
         Thread.sleep(20000);
         System.out.println("File added to scheduled course at instructor end ");
		...
		Thread.sleep(5000);
          ...
          Thread.sleep(5000);
			...
			driver.findElement(By.id("tinymce")).sendKeys("This scheduled course  is created via automation testing at Instructor end");
			driver.switchTo().parentFrame();
			Thread.sleep(5000);
			...
			driver.findElement(By.xpath(OR.getProperty("refresh_course"))).click();
			Thread.sleep(10000);
			System.out.println(" Scheduled course created successfully via automation at Instructor end ");
		...
		//enrollment process for course
			...
			//click on enroll_new
			 ...
			 // Thread.sleep(3500); 
			  //enter user name
			  driver.findElement(By.id("byName")).sendKeys("learner03");
			  Thread.sleep(3500);
			  //enter email id
			  driver.findElement(By.xpath(OR.getProperty("email"))).sendKeys("learner03@yopmail.com");
			  Thread.sleep(1500);
			...
			//back to course module
				...
				//System.out.println("============================================");
				System.out.println("Scheduled course automation done at instructor end");
				//System.out.println("============================================");
