...
public class LiveClasses extends Testbase {

	@Test(priority=1)
	public void liveclass() throws InterruptedException, AWTException, IOException
	{ 
		//create live class
		
		
		File file = new File("src\\test\\resources\\images\\11.jpg");
		...
		Thread.sleep(5000);
		//fill the form
		driver.findElement(By.id("txtTitle")).sendKeys("LiveClass_09_create_via_automation");
		Thread.sleep(1000);
		driver.findElement(By.id("txtTagline")).sendKeys("LiveClass_Testing_via_automation");
		Thread.sleep(3000);
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("//input[@id='file']")).sendKeys(localFilePath);
		Thread.sleep(4000);
		...
		*/
		...
		//message in console
		System.out.print("Live class is created sucessfully");
		Thread.sleep(3500);
		driver.findElement(By.xpath(OR.getProperty("refresh_course"))).click();
		Thread.sleep(3500);
		...
		//Editing live class
		 ...
		 // driver.findElement(By.xpath(OR.getProperty("edit_class"))).click();
		  driver.findElement(By.xpath("//div[@class='mdl-grid maxGridSize dateRange']//div[1]//div[1]//div[1]//div[1]//div[2]//div[1]//ul[1]//li[1]//div[1]//button[1]//span[2]")).click();
		  ...
		  Thread.sleep(1000);
		  driver.findElement(By.id("txtTitle")).sendKeys("LiveClass_09_Edit_Done");
		  Thread.sleep(1000);
		  driver.findElement(By.id("txtTagline")).clear();
		  Thread.sleep(1000);
		  driver.findElement(By.id("txtTagline")).sendKeys("LiveClass_Edit_Testing_via_automation"); 
		  Thread.sleep(1000);
		  driver.findElement(By.id("RecurringControl1_txtStartDate")).click();
		  Thread.sleep(1500); 
		  driver.findElement(By.xpath("//a[text()='30']")).click();
		  ...
		  driver.findElement(By.id("txtDuration")).clear();
		  Thread.sleep(1000);
		  driver.findElement(By.id("txtDuration")).sendKeys("60"); 
		  // Max attendees values enter 
		  Thread.sleep(2000);
		  driver.findElement(By.id("txtMaxUsers")).clear();
		  Thread.sleep(1000);
		  ...
		  Thread.sleep(3500);
		  System.out.println("      ");
		  System.out.println("Class is edited successfully");
		  Thread.sleep(2500);
		  ...
		  Thread.sleep(3500);
		  //enter email id
		  driver.findElement(By.xpath(OR.getProperty("email"))).sendKeys(
		  "learner01@yopmail.com");
		  Thread.sleep(1500);
