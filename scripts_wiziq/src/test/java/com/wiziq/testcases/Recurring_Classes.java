...
public class Recurring_Classes extends Testbase{

	@Test(priority=7)
	public void recurring() throws InterruptedException, AWTException, IOException
	{ 
		File file = new File("src\\test\\resources\\images\\16.jpg");
		...
		Thread.sleep(5000);
		//fill the form
		driver.findElement(By.id("txtTitle")).sendKeys("Recurring_class27_created_via_automation");
		Thread.sleep(1000);
		driver.findElement(By.id("txtTagline")).sendKeys("Testing_via_automation");
		Thread.sleep(3000);
	  ...
	  //select recurring class type from dropdown
		...
		*/
		...
		Thread.sleep(2000);
  		...
  		inst1.selectByVisibleText("instructor02");
  		Thread.sleep(1500);
  		driver.findElement(By.id("imgUpDown")).click();
  		Thread.sleep(1500);
		...
		System.out.println("your automation recurring class is created");
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("//input[@id='searchClass']")).sendKeys("Recurring_class27");
		Thread.sleep(3000);
		System.out.print("RecurringClass_automation_done");
		Thread.sleep(9000);
